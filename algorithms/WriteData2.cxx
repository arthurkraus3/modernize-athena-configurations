...
/** @file AthenaPoolExampleAlgorithms/src/WriteData2.cxx
 *  @brief This file contains the implementation for the WriteData2 class.
 *  @author Peter van Gemmeren <gemmeren@anl.gov>
 *  $Id: WriteData2.cxx,v 1.25 2008-12-10 21:28:11 gemmeren Exp $
 **/

#include "WriteData2.h"
...
WriteData2::WriteData2(const std::string& name, ISvcLocator* pSvcLocator)
...
//___________________________________________________________________________
StatusCode WriteData2::initialize() {
...
//___________________________________________________________________________
StatusCode WriteData2::execute (const EventContext& ctx) const {
...
//___________________________________________________________________________
StatusCode WriteData2::finalize() {
